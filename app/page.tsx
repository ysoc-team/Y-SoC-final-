...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black scroll-smooth">
      ...
      <section className="pt-24 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden min-h-screen flex items-center">
          ...
          <div className="text-center">
            ...
            >
              ...
              >
                <Badge 
                  variant="secondary" 
                  className="px-6 py-3 text-sm font-semibold border-2 border-primary/30 bg-gradient-to-r from-primary/10 via-primary/5 to-secondary/10 hover:from-primary/20 hover:via-primary/10 hover:to-secondary/20 transition-all duration-500 text-white backdrop-blur-sm shadow-lg hover:shadow-xl"
                  style={{
            ...
            <motion.h1 
              className="text-4xl md:text-6xl lg:text-7xl font-black mb-8 leading-tight gpu-accelerated text-white"
            ...
            <motion.div 
              className="text-lg md:text-xl lg:text-2xl text-white mb-16 max-w-4xl mx-auto"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="space-y-4">
                ...
                <motion.div 
                  className="text-base md:text-lg lg:text-xl font-medium text-gray-300"
                  style={{
